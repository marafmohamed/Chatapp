...
export default function Home() {
  const [UserConnectedToSocket, setUserConnectedToSocket] = useState(false);
  const { user, ENDPOINT, socket, setSocket ,isNewNotification} = useAuth();
  ...
  return (
    <div className=" h-screen w-screen flex flex-col overflow-hidden ">
      ...
      {userInfo && (
        <>
          <div className="Navbar w-full shadow-lg shadow-gray-900 flex items-center justify-between  bg-slate-800 py-4 px-4 rounded-b-xl">
